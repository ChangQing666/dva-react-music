const domain = `https://www.cqfee.top/api`;
const apiPath = {
  ...
  CHECK_MUSIC:      `${domain}/check/music`, //检查音乐是否可用
  MUSIC_URL:       `${domain}/song/url`,        //获取音乐url   GET /song/url?id=33894312&proxy=http://39.104.104.12:9520
